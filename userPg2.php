                ...
                $pwErr = "Password is required!";
                    ...
                    if (mysqli_num_rows($query) == 1) {
                        ...
                        if ($row["_level_"] == 0) {
                            ...
                            $_SESSION["_level_"] = 2;
                            $_SESSION["logIn"] = true;
                            header("Location: user.php"); // Delivery Privileges
                        }
                    } else {
...
<html>
    ...
    <body onload = "writeToOrders()">
        ...
        <div id = "buttons">
            ...
            <div id = "pageCount">
                <label name = "currentPage">2</label>
                <label>/</label>
